...
function gameOver() {
    ...
    document.getElementById("coachJ").style.display = "block"
    document.getElementById("coachJ").classList.add("rollIn")
    var audio = new Audio('assets/sounds/gameover.mp3');
    audio.play();
    setTimeout(function () {
        document.getElementById("coachJ").classList.remove("rollIn")
        document.getElementById("coachJ").classList.add("zoomInUp")
    }, 3000);
